...
public class DockerService {
    ...
    // Inject Docker Hub credentials from environment variables via Spring
    ...
    private WebClient buildClient() {
        String auth = Base64.getEncoder()
                .encodeToString((dockerHubUsername + ":" + dockerHubPassword).getBytes(StandardCharsets.UTF_8));
    ...
    public void createRepository(String clientName) {
        try {
            ...
            String encodedUsername = UriUtils.encodePathSegment(dockerHubUsername, StandardCharsets.UTF_8);
    ...
    public void pushDockerImage(MultipartFile dockerImage, String clientName) {
        ...
        try {
            ...
            tempFile = File.createTempFile(clientName, ".tar");
            ...
            try (OutputStream os = loginProcess.getOutputStream()) {
                os.write(dockerHubPassword.getBytes(StandardCharsets.UTF_8));
                os.flush();
            }
